...
const Contact = () => {
    return (
        <>
            ...
            <div className='w-full h-auto  text-white py-10 px-4 md:px-[195px]'>
                <div className='text-center'>
                    <p className='text-[#737373] font-bold text-sm'>VISIT OUR SERVICES</p>
                    <h3 className='text-[#252B42] font-bold text-[40px]'>We help small businesses <br />
                        with big ideas</h3>
                    <div className='flex justify-center items-center gap-4 mt-5 md:flex-row flex-col'>
                        <div className='w-[330px] h-[400px] border border-[#23a6f0] rounded-md mx-auto mt-10 flex flex-col justify-center items-center gap-2 transform transition duration-500 hover:scale-110'>
                            <BsTelephone size={72} className='text-[#23a6f0] font-bold transform transition duration-500 hover:scale-110' />
                            <div> <span className='text-[#252B42] text-sm font-semibold'>georgia.young@example.com</span> <br />
                                <span className='text-[#252B42] text-sm font-semibold'>georgia.young@ple.com</span></div>
                            <p className='text-[#252B42] font-semibold text-[24px]'>Get Support</p>
                            <Link href={""}><button className='text-[#23a6f0] bg-transparent border border-[#23a6f0] text-sm py-3 px-5 mt-4 rounded-full transition-transform transform hover:translate-y-0 active:translate-y-1'>
                                Submit Request</button>
                            </Link>
                        </div>

                        <div className='w-[330px] h-[400px] bg-[#252B42] border border-[#23a6f0] rounded-md mx-auto mt-10 flex flex-col justify-center items-center gap-2 transform transition duration-500 hover:scale-110'>
                            <FaLocationDot size={72} className='text-[#23a6f0] font-bold transform transition duration-500 hover:scale-110' />
                            <div> <span className='text-[#fafafa] text-sm font-semibold'>georgia.young@example.com</span> <br />
                                <span className='text-[#fafafa] text-sm font-semibold'>georgia.young@ple.com</span></div>
                            <p className='text-[#fafafa] font-semibold text-[24px]'>Get Support</p>
                            <Link href={""}><button className='text-[#23a6f0] bg-transparent border border-[#23a6f0] text-sm py-3 px-5 mt-4 rounded-full transition-transform transform hover:translate-y-0 active:translate-y-1'>
                                Submit Request</button>
                            </Link>
                        </div>
                        ...
                        <div className='w-[330px] h-[400px] border border-[#23a6f0] rounded-md mx-auto mt-10 flex flex-col justify-center items-center gap-2 transform transition duration-500 hover:scale-110'>
                            <IoIosMail size={72} className='text-[#23a6f0] font-bold transform transition duration-500 hover:scale-110' />
                            <div> <span className='text-[#252B42] text-sm font-semibold'>georgia.young@example.com</span> <br />
                                <span className='text-[#252B42] text-sm font-semibold'>georgia.young@ple.com</span></div>
                            <p className='text-[#252B42] font-semibold text-[24px]'>Get Support</p>
                            <Link href={""}><button className='text-[#23a6f0] bg-transparent border border-[#23a6f0] text-sm py-3 px-5 mt-4 rounded-full transition-transform transform hover:translate-y-0 active:translate-y-1'>
